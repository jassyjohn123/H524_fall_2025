...
\Large AI-Enhanced Public Health Data Analysis Project\\
Fall 2025}}
...
Teams of 7 students will conduct a comprehensive biostatistical analysis of a real public health dataset as the culminating course assessment (25\% of final grade). This project replaces traditional final exams and demonstrates effective integration of AI tools throughout the research process while maintaining scientific rigor and reproducibility.
\end{tcolorbox}
...
\item Conduct literature review using AI-assisted search strategies
\item Document AI tool usage for literature synthesis
\item Identify gaps your analysis will address
\end{itemize}

\subsection{Part 2: Data Management and Exploration (20\%)}
\begin{itemize}
\item Data cleaning and preprocessing with AI assistance
\item Exploratory data analysis with appropriate visualizations
\item Missing data assessment and handling strategy
\item Document all AI-generated code with verification steps
\end{itemize}
...
\item Apply appropriate statistical methods from H524 curriculum:
    ...
    \end{itemize}
\item Use AI to explore alternative analytical approaches
\item Validate all AI-suggested methods against course materials
\item Conduct sensitivity analyses where appropriate
\end{itemize}

\subsection{Part 4: AI Integration and Documentation (20\%)}
\begin{itemize}
\item Maintain an AI usage log throughout the project
\item Document all prompts used for substantial tasks
\item Include verification steps for AI-generated results
\item Reflect on AI benefits and limitations encountered
\item Create a "lessons learned" section on AI use
\end{itemize}
...
\item Anticipated AI tools and usage
\end{itemize}
...
\item AI usage documentation appendix
...
\item Individual reflection on learning and AI tool usage (1 page per student)
\end{itemize}
...
\begin{enumerate}
\item \textbf{GitHub Copilot:} Use for R code generation and debugging
\item \textbf{Literature Review:} Use AI to identify relevant papers and synthesize findings
\item \textbf{Statistical Methods:} Consult AI for method selection and interpretation
\item \textbf{Data Visualization:} Generate initial visualization code with AI assistance
\item \textbf{Writing Support:} Use AI for editing and clarity (with attribution)
\end{enumerate}
...
Verification: [How you verified the output]
Modifications: [Changes made to AI output]
\end{verbatim}
\end{tcolorbox}
...
\subsection{Office Hours Support}
\begin{itemize}
\item Regular office hours: Wednesday 10:00-11:30 AM
\item Special project office hours: Weeks 5, 7, 9
\item Schedule team consultations via Canvas
\end{itemize}
