...
\subsection{Task 3: AI Integration and Documentation (25 points)}
\begin{enumerate}
\item \textbf{AI Tool Usage:}
   \begin{itemize}
   \item Use GitHub Copilot for at least 50\% of your R code generation
   \item Use an AI assistant (ChatGPT, Claude, etc.) for interpretation guidance
   \item Document each instance of AI use with the provided template
   \end{itemize}

\item \textbf{Verification Process:}
   \begin{itemize}
   \item Manually check key statistical calculations
   \item Verify AI-generated interpretations against course materials
   \item Document any corrections made to AI outputs
   \end{itemize}

\item \textbf{AI Usage Log:}
   \begin{itemize}
   \item Complete the provided AI documentation template
   \item Include specific prompts used and outputs received
   \item Reflect on benefits and limitations of AI assistance
   \end{itemize}
\end{enumerate}

\subsection{Task 4: Written Report (20 points)}
\begin{enumerate}
...
\item \textbf{AI Usage Documentation (.pdf):}
   \begin{itemize}
   \item Completed AI documentation template
   \item Detailed log of all AI interactions
   \item Reflection on AI assistance experience
   \end{itemize}
...
\section{AI Usage Requirements}

\begin{tcolorbox}[colback=aiblue!5,colframe=aiblue,boxrule=1pt,arc=2pt,left=6pt,right=6pt,top=6pt,bottom=6pt]
\textbf{Required AI Integration:}
\begin{enumerate}
\item \textbf{GitHub Copilot:} Use for R code generation, debugging, and optimization
\item \textbf{AI Assistant:} Use for statistical interpretation and method selection guidance
\item \textbf{Documentation:} Record all AI interactions using the provided template
\item \textbf{Verification:} Independently verify all AI-generated content
\end{enumerate}

\textbf{AI Documentation Template:}
\begin{verbatim}
## AI Usage Entry [Number]
Date: [Date]
Tool: [GitHub Copilot/ChatGPT/Claude/etc.]
Task: [Specific statistical task]
Prompt: [Exact prompt or request]
AI Output: [Summary of response]
Verification Method: [How you checked the output]
Final Decision: [What you used/modified]
Reflection: [Benefits and limitations observed]
\end{verbatim}
\end{tcolorbox}
...
\midrule
Descriptive Analysis & 25 & Comprehensive data exploration and visualization \\
Hypothesis Testing & 30 & Appropriate test selection and correct interpretation \\
AI Integration \& Documentation & 25 & Effective AI use with thorough documentation \\
Written Report & 20 & Clear communication and professional presentation \\
\midrule
...
\item Effective AI integration with complete documentation
...
\item Limited AI integration or incomplete documentation
...
\item ChatGPT, Claude, or similar AI assistant for consultation
...
\item \textbf{Ask Questions:} Use office hours if you encounter difficulties
