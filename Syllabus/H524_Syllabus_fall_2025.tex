...
\noindent\textbf{Office Hours:} Wednesdays 10:00--11:30am (153 Milam or via Zoom)

Office hours are scheduled to accommodate diverse student schedules, and I am very flexible about meeting either in person or via Zoom with an appointment. This approach has worked well in previous classes I teach. Additionally, lab time (Wednesday 8:00--9:50am) is an excellent opportunity to ask questions. As with other classes I teach, there will be one dedicated office hours day during Week 9 (in lieu of formal lecture) so that everyone can attend.
...
\begin{itemize}[leftmargin=20pt,label=--]
\item \textcolor{aiblue}{\emph{AI Integration:} Effectively prompt AI tools for statistical tasks and critically evaluate their outputs.}
\item \textcolor{aiblue}{\emph{Verification Skills:} Validate AI-generated code and results through independent checking.}
\end{itemize}
\end{itemize}
...
\noindent\textbf{Grading Components}
