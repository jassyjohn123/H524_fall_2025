...
\noindent\textbf{Evaluation:} 25\% homework (includes AI-enhanced problem sets), 25\% midterm exam, 25\% final exam, 15\% group project, 10\% class participation and AI reflection exercises.
...
\noindent\textbf{Group Project (15\%)}

Teams of 3-4 students will complete a biostatistics analysis project that demonstrates effective AI integration. The project will be due during Week 10 with presentations scheduled during the final exam period.

\textbf{Project Requirements:}
\begin{itemize}[leftmargin=20pt]
\item Apply statistical methods covered in H524 to a public health dataset
\item Document AI tool usage throughout the analysis process
\item Include verification steps showing how AI-generated results were validated
\item Present findings in a 10-minute team presentation
\item Submit a reproducible R analysis with clear AI attribution
\end{itemize}

\textbf{Grading Criteria:}
\begin{itemize}[leftmargin=20pt]
\item Statistical analysis correctness (40\%)
\item Effective and documented AI integration (30\%)
\item Presentation quality and clarity (20\%)
\item Reproducibility and code quality (10\%)
\end{itemize}
