...
\begin{frame}[fragile]
\frametitle{One-Sided t-Test in R (Part 1 - Setup)}
\small
\begin{verbatim}
...
\begin{frame}[fragile]
\frametitle{One-Sided t-Test in R (Part 2 - Manual Calculation)}
\small
\begin{verbatim}
# Manual calculation
xbar <- mean(bp)
...
\begin{frame}[fragile]
\frametitle{Checking Normality in R (Part 1 - Visual Checks)}
\small
\begin{verbatim}
# Generate some data
set.seed(524)
...
\begin{frame}[fragile]
\frametitle{Checking Normality in R (Part 2 - Tests)}
\small
\begin{verbatim}
# 3. Boxplot
...
\begin{frame}[fragile]
\frametitle{Complete Hypothesis Test Example (Part 1 - Setup)}
\tiny
\begin{verbatim}
...
\begin{frame}[fragile]
\frametitle{Complete Hypothesis Test Example (Part 2 - Interpret)}
\small
\begin{verbatim}
# Step 4: Interpret
...
\begin{frame}[fragile]
\frametitle{AI Demo: Understanding P-values (Part 1)}
...
\begin{frame}[fragile]
\frametitle{AI Demo: Understanding P-values (Part 2)}
\small
\begin{verbatim}
...
\begin{frame}[fragile]
\frametitle{AI Demo: Checking Assumptions (Part 1 - Visual)}
...
\begin{frame}[fragile]
\frametitle{AI Demo: Checking Assumptions (Part 2 - Tests)}
\tiny
\begin{verbatim}
# 4. Density plot
