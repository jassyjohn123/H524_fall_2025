...
\item \textbf{(Week 9 Preview - Optional):} Calculate and interpret odds ratios and relative risks
\end{enumerate}
...
\subsection{Exercise 1.3: Blood Type Distribution}

\textbf{Scenario:} A hospital blood bank wants to determine if their patient blood type distribution matches the U.S. population. They sample 200 patients and compare to national proportions: A (45\%), B (40\%), AB (11\%), O (4\%).

\textbf{Observed data:} A=85, B=78, AB=28, O=9
...
cat("Blood Type Distribution Test\n")
cat("==============================\n")
cat("Sample size:", total, "\n")
cat("Observed: A=", observed[1], ", B=", observed[2],
    ", AB=", observed[3], ", O=", observed[4], "\n", sep="")
cat("Expected proportions: A=45%, B=40%, AB=11%, O=4%\n\n")

cat("Expected counts:\n")
print(round(chi_result$expected, 2))

cat("\nChi-square statistic:", round(chi_result$statistic, 4), "\n")
cat("Degrees of freedom:", chi_result$parameter, "\n")
cat("P-value:", round(chi_result$p.value, 4), "\n\n")

if (chi_result$p.value > 0.05) {
  cat("Conclusion: Hospital distribution consistent with U.S. population\n")
} else {
  cat("Conclusion: Hospital distribution differs from U.S. population\n")
}
\end{rcode}
...
\subsection{Exercise 2.2: Calculating Effect Sizes (Week 9 Preview - Optional)}

\textbf{Note:} This exercise previews Week 9 content on effect sizes. It's optional for Week 8 but useful for understanding the strength of associations.
