...
\newtcolorbox{answerbox}{
  ...
  bottom=5pt,
  breakable,
  title=\textcolor{answergreen}{\textbf{ANSWER}}
}
...
\section{Practice Problems - SOLUTIONS}
...
\item Median: 135
\item SD: 13.98
\item Number with high BP: 2 patients
\item Proportion with high BP: 0.286 (28.6\%)
\end{itemize}
\end{answerbox}
...
\begin{tabular}{lrrr}
\toprule
& \multicolumn{2}{c}{Test Result} & \\
\cmidrule{2-3}
Flu Status & Positive & Negative & Total \\
\midrule
Yes & 40 & 5 & 45 \\
No & 30 & 425 & 455 \\
\midrule
...
\begin{answerbox}
\begin{rcode}
# a) Probability that exactly 12 patients respond successfully
dbinom(12, size = 15, prob = 0.8)

# b) Probability that at least 12 patients respond successfully
pbinom(11, size = 15, prob = 0.8, lower.tail = FALSE)
# OR
sum(dbinom(12:15, size = 15, prob = 0.8))

# c) Expected number of successful responses
...
\textbf{Results:}
\begin{itemize}
\item Probability of exactly 12 successes: 0.2501 (25.01\%)
\item Probability of at least 12 successes: 0.6020 (60.20\%)
\item Expected number of successes: 12
\end{itemize}
\end{answerbox}
...
\begin{answerbox}
\begin{rcode}
# a) Proportion of adults with BMI < 25 (normal weight)
pnorm(25, mean = 26.5, sd = 5)

# b) Proportion with BMI >= 30 (obese)
pnorm(30, mean = 26.5, sd = 5, lower.tail = FALSE)

# c) BMI value at the 75th percentile
...
abline(v = 25, col = "green", lty = 3, lwd = 1)  # Normal/Overweight
abline(v = 30, col = "orange", lty = 3, lwd = 1) # Overweight/Obese
...
\textbf{Results:}
\begin{itemize}
\item Proportion with BMI $<$ 25: 0.3821 (38.21\%)
\item Proportion with BMI $\geq$ 30: 0.2420 (24.20\%)
\item 75th percentile BMI: 29.87
\end{itemize}
\end{answerbox}
