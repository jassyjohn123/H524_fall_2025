...
# Week 2 Lab Answer Key
# R Basics and Introduction to Probability
# ============================================================================
...
# Exercise 1.1: Basic Arithmetic (examples from lab)
# ----------------------------------------------------------------------------
...
# TRY IT YOURSELF: Average of three blood pressure readings
# ----------------------------------------------------------------------------
(120 + 140 + 135) / 3


# Exercise 1.2: Storing Values in Variables (examples from lab)
# ----------------------------------------------------------------------------
...
# PRACTICE: Mean arterial pressure approximation
# ----------------------------------------------------------------------------
systolic_bp <- 120
diastolic_bp <- 80
mean_arterial_pressure <- (systolic_bp + diastolic_bp) / 2
...
# Exercise 2.1: Creating Vectors (examples from lab)
# ----------------------------------------------------------------------------
...
# Exercise 2.2: More Vector Operations (examples from lab)
# ----------------------------------------------------------------------------
...
# PRACTICE: Cholesterol readings analysis
# ----------------------------------------------------------------------------
...
# Exercise 2.3: Accessing Specific Values (examples from lab)
# ----------------------------------------------------------------------------
...
# Exercise 3.1: Building a Simple Data Frame (examples from lab)
# ----------------------------------------------------------------------------
...
# Exercise 3.2: Accessing Data Frame Columns (examples from lab)
# ----------------------------------------------------------------------------
...
# Exercise 4.1: Simple Probability Calculations (examples from lab)
# ----------------------------------------------------------------------------
...
# Exercise 4.2: Creating a 2x2 Table (examples from lab)
# ----------------------------------------------------------------------------
...
# Exercise 4.3: Calculating Sensitivity and Specificity (examples from lab)
# ----------------------------------------------------------------------------
...
# Exercise 5.1: Binomial Distribution (examples from lab)
# ----------------------------------------------------------------------------
...
# Exercise 5.2: Normal Distribution (examples from lab)
# ----------------------------------------------------------------------------
...
mean(bp_readings >= 140)
# OR
sum(bp_readings >= 140) / length(bp_readings)
...
# ----------------------------------------------------------------------------
# A new medication has an 80% success rate. A clinic treats 15 patients with
# this medication.
...
x_values <- seq(10, 45, by = 0.1)
y_values <- dnorm(x_values, mean = 26.5, sd = 5)
...
# Add vertical lines at BMI thresholds
abline(v = 25, col = "green", lty = 3, lwd = 1)  # Normal/Overweight cutoff
abline(v = 30, col = "orange", lty = 3, lwd = 1)  # Overweight/Obese cutoff

legend("topright",
       legend = c("Mean (26.5)", "Normal (25)", "Obese (30)"),
...
save.image("week2_lab_answer_key.RData")

cat("\n============================================\n")
cat("Week 2 Lab Answer Key - Complete!\n")
cat("============================================\n")
