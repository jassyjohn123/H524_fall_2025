...
\hline
Treatment group (control, low dose, high dose) & \textcolor{answergreen}{\textbf{Ordinal}} & \textcolor{answergreen}{Categories with natural ordering from no treatment to increasing dose levels} \\[2ex]
\hline
\end{tabular}
\end{center}
...
\item Variance: \textcolor{answergreen}{\textbf{1046}} mmHg$^2$ \textcolor{answergreen}{(sample variance)}
\item Standard Deviation: \textcolor{answergreen}{\textbf{32.34}} mmHg \textcolor{answergreen}{(square root of variance)}
\item Standard Error of Mean: \textcolor{answergreen}{\textbf{13.20}} mmHg \textcolor{answergreen}{(32.34/$\sqrt{6}$)}
\end{itemize}

\textcolor{answergreen}{\textbf{Discussion:}} These measures tell us the blood pressure data has considerable spread (range = 83), high variability (SD = 32.34), and the mean has substantial uncertainty (SEM = 13.20).
...
#    110     120     135     143   161.2     193

# Additional statistics
length(blood_pressure)    # n = 6
sd(blood_pressure)        # SD = 32.34
var(blood_pressure)       # Var = 1046
range(blood_pressure)     # Range: 110 193
IQR(blood_pressure)       # IQR = 41.25
...
\item Any surprising insights: \textcolor{answergreen}{\textbf{IQR = 41.25, shows middle 50\% spread}}
\end{itemize}
