...
\section{Part 3: AI-Enhanced Rate Calculations}

\subsection{Exercise 3.1: Automating Rate Calculations with AI}

\begin{tcolorbox}[colback=aiblue!10,colframe=aiblue,boxrule=1pt,arc=2pt,left=6pt,right=6pt,top=6pt,bottom=6pt]
\textbf{\textcolor{aiblue}{AI Challenge:}} Use AI to help create a function that calculates and compares rates between populations.

\textbf{Your AI Prompt:} ``Help me create an R function that calculates rates per specified population size (like per 1,000 or per 100,000) and compares multiple groups. Include error checking and clear output formatting.''
\end{tcolorbox}

\textbf{AI Response:}
\begin{lstlisting}
# Paste AI-generated function here:
...
\textbf{Test the Function:}
\begin{lstlisting}
# Test with our county data
# Your test code here:
...
\begin{itemize}
\item[$\square$] Does the function calculate rates correctly?
\item[$\square$] Does it handle different population bases (per 1,000, per 100,000)?
\item[$\square$] Are there appropriate error checks?
\item[$\square$] Is the output clear and interpretable?
\end{itemize}

\subsection{Exercise 3.2: Advanced AI Prompt for Epidemiological Analysis}

\begin{tcolorbox}[colback=aiblue!10,colframe=aiblue,boxrule=1pt,arc=2pt,left=6pt,right=6pt,top=6pt,bottom=6pt]
\textbf{\textcolor{aiblue}{Advanced AI Prompt:}} ``I need to perform a comprehensive epidemiological analysis comparing disease rates across different populations with age standardization. Create R code that handles multiple age groups, calculates both crude and age-adjusted rates, and provides appropriate visualizations.''
\end{tcolorbox}

\textbf{Document AI Response:}
\begin{enumerate}
\item \textbf{Key functions suggested:}

\vspace{2cm}

\item \textbf{New concepts learned:}

\vspace{2cm}

\item \textbf{Code that needed modification:}

\vspace{2cm}

\end{enumerate}

\section{Part 4: Advanced R Programming}

\subsection{Exercise 4.1: Creating Functions}
...
\subsection{Exercise 4.2: Working with Real Data Structures}
...
\section{Part 5: Statistical Thinking and Study Design}

\subsection{Exercise 5.1: Connecting Rates to Biostatistics}
...
\subsection{Exercise 5.2: Bias and Confounding Preview}
...
\section{Part 6: AI Integration and Documentation Practice}

\subsection{Exercise 6.1: Comprehensive AI Workflow}

\begin{tcolorbox}[colback=aiblue!10,colframe=aiblue,boxrule=1pt,arc=2pt,left=6pt,right=6pt,top=6pt,bottom=6pt]
\textbf{\textcolor{aiblue}{Task:}} Use AI to help analyze a complete epidemiological dataset and document your entire workflow.

\textbf{Your Comprehensive AI Prompt:}
``I have epidemiological data with counties, age groups, cases, and populations. Help me create a complete analysis workflow that includes: 1) data validation, 2) crude rate calculations, 3) age-standardized rates, 4) appropriate visualizations, 5) statistical interpretation, and 6) recommendations for further analysis.''
\end{tcolorbox}

\textbf{Document Your AI Interaction:}

\begin{enumerate}
\item \textbf{Initial AI suggestions:}

\vspace{2cm}

\item \textbf{Code you tested:}
\begin{lstlisting}
# Paste and test AI code here:


\end{lstlisting}

\item \textbf{Modifications needed:}

\vspace{2cm}

\item \textbf{Final verified analysis:}

\vspace{2cm}

\item \textbf{What you learned about AI capabilities and limitations:}

\vspace{2cm}

\end{enumerate}

\section{Part 7: Preparation for Future Topics}

\subsection{Exercise 7.1: Probability Preview}
...
\item AI can accelerate complex analyses but requires careful verification
\end{itemize}
...
\textbf{Complete Documentation Required:}

\textbf{Tools Used:} \rule{8cm}{0.4pt}
...
\textbf{AI-Generated Code Verification:}
\begin{itemize}
\item Code tested and working: $\square$ Yes $\square$ No
\item Modifications made: \rule{8cm}{0.4pt}
\item Errors found: \rule{8cm}{0.4pt}
\end{itemize}

\textbf{Learning Assessment:}
\begin{itemize}
\item Most useful AI contribution: \rule{8cm}{0.4pt}
\item Biggest AI limitation encountered: \rule{8cm}{0.4pt}
\item Confidence in AI-assisted results (1-10): \rule{2cm}{0.4pt}
\item Independent verification methods used: \rule{8cm}{0.4pt}
\end{itemize}

\textbf{Next Steps for AI Integration:}
